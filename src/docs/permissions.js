 ...
 * @returns {object}
 */
export function filterOpenApiByPermissions(document, permissions = [], options = {}) {
...
export const filterOpenAPIByPermissions = filterOpenApiByPermissions;
export const filterOpenapiByPermissions = filterOpenApiByPermissions;
 ...
 * @returns {object}
 */
export function filterPostmanByPermissions(collection, permissions = [], options = {}) {
  const granted = permissionSet(permissions);
  const includePublic = options.includePublic !== false;
  const requireAll = options.requireAll !== false;
